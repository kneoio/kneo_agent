...
class SoundFragmentRepo:
    async def get_brand_songs(self, brand_id: UUID, fragment_type: str = "SONG", page: int = 1, page_size: int = 20) -> Dict[str, Any]:
...
sound_fragment_repo = SoundFragmentRepo()


async def get_brand_songs(brand_id: UUID, fragment_type: str = "SONG", page: int = 1, page_size: int = 20) -> Dict[str, Any]:
    return await sound_fragment_repo.get_brand_songs(brand_id, fragment_type, page, page_size)
